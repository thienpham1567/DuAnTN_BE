...
public class OrderStatusConverter implements IConverter<DbOrderStatus, OrderStatus>, ICombiner<DbOrderStatus> {
    ...
    public DbOrderStatus convertModelToDb(OrderStatus input) {
        return input == null ? null : new DbOrderStatus(
                input.description,
                input.created
        );
    }
    ...
    public OrderStatus convertDbToModel(DbOrderStatus input) {
        return input == null ? null : new OrderStatus(
                input.orderStatusId,
                input.description
        );
    }
